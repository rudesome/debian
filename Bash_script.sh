    ...
    apt-get install python-apt zsh git zsh-common fonts-powerline linuxlogo figlet vim lsb-release sudo dnsutils host whois telnet tmux lsof iputils-ping ipcalc ntp net-tools ntpdate mtr iperf -qq -y
